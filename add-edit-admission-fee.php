...
if (is_null($id) && isset($_GET['date_from'])) $admission_fee->date_from = $accounts->date('d/m/Y', $_GET['date_from']);
if (is_null($id) && isset($_GET['date_to'])) $admission_fee->date_to = $accounts->date('d/m/Y', $_GET['date_to']);
