...
if (isset($_POST['action']) && $_POST['action'] == 'collect-monthly-fee') {
    $result = $accounts->collectMonthlyFee($_POST, $id);
...
$student = $accounts->getStudentByAdmssionNo($monthly_fee->admission_no);

require_once 'includes/header.php';
require_once 'includes/sidebar.php';
?>

<?php $title = 'Collect Monthly Fee'; ?>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="total_amount" class="form-control required" value="<?= $monthly_total_fee; ?>" required readonly>
                        </div>
                    </div>
                    <div class="col-md-3">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pull-right">
                            <button class="btn btn-secondary shadow-none mr-2" type="submit" name="action" value="collect-monthly-fee">Submit</button>
