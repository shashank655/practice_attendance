      ...
      <div class="row">
         ...
         <div class="col-lg-6">
            <div class="content-page">
               ...
               <div id="studentMonthlyAttendanceCart" style="height: 350px;"></div>
            </div>
         </div>
      </div>
      <div class="row mt-4">
         ...
         <div class="col-lg-6">
            <div class="content-page">
               <div class="page-title">Teacher Monthly Attendance</div>
               <div id="teacherMonthlyAttendanceCart" style="height: 350px;"></div>
            </div>
         </div>
         <div class="col-lg-6">
            <div class="content-page">
                           ...
                           <tbody>
                              <?php $i=1; ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo ' Start Date:'.$value['start_date'].', End Date:'.$value['end_date']; ?></td>
...
<div class="modal" id="daily-teacher-attendance-progress-modal">
   <div class="modal-dialog modal-lg">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Attendance for the month of ....</h4>
         ...
         <div class="modal-body">
            <div id="daily-teacher-attendance-progress"></div>
         </div>
      </div>
   </div>
</div>
