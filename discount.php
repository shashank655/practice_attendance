...
if (isset($_POST['action']) && $_POST['action'] == 'add-edit-discount') {
    $result = $accounts->addEditDiscount($_POST, $id);
    $accounts->redirect(BASE_ROOT . 'discount.php');
}

if ($id) {
    $discount = $accounts->getDiscount($id);
} else {
...
$discounts = $accounts->getDiscounts();

require_once 'includes/header.php';
require_once 'includes/sidebar.php';
?>

<?php $title = $id ? 'Edit Discount' : 'Create Discount'; ?>
                            ...
                            <?php foreach ($discounts->results as $key => $discount) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="discount.php?id=<?= $discount->id; ?>" class="text-dark">
