...
require_once '../class/TransferCertificate.php';
$transferCertificate = new TransferCertificate();
$data = $_REQUEST;
if ($data['type'] == 'Add') {
    $result = $transferCertificate->AddTransferCertificate($data);
    if ($result) {
        $_SESSION['Msg'] = "Transfer Certificate added successfully!";
        $_SESSION['success'] = true;
        header('Location: ' . BASE_ROOT.'transfer-certificate-listing.php');
    } else {
