    ...
    <script type="text/javascript" src="<?php echo BASE_ROOT ?>assets/js/bootstrap-datetimepicker.min.js"></script>
	<script type="text/javascript" src="<?php echo BASE_ROOT ?>assets/plugins/morris/morris.min.js"></script>
    <script type="text/javascript" src="<?php echo BASE_ROOT ?>assets/plugins/raphael/raphael-min.js"></script>
