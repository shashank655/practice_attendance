...
if ($admissionId != NULL) { $result = $admission->getAdmissionInfo($admissionId); 
	if ($result == NULL) { $admissionId = ''; } }?>
<?php 
                ...
                <div class="page-header">
					<div class="row">
						<div class="col-lg-7 col-md-12 col-sm-12 col-12">
							<h5 class="text-uppercase">New Admission</h5>
						</div>
						<div class="col-lg-5 col-md-12 col-sm-12 col-12">
							<ul class="list-inline breadcrumb float-right">
								<li class="list-inline-item"><a href="dashboard.php">Home</a></li>
								<li class="list-inline-item"> New Admission</li>
							</ul>
						</div>
					</div>
				</div>
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">	
							<form id="addStudentForm" action="employee/process/processNewAdmission.php" method="post" novalidate="novalidate" enctype="multipart/form-data" class="custom-mt-form">
							<input type="hidden" name="type" value="<?php echo $admissionId == '' ? 'Add' : 'Update'; ?>" />
							<input type="hidden" name="admissionId" value="<?php echo $admissionId; ?>" />
									<div class="row">
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="form-group custom-mt-form-group">
													<select id="gender" name="gender">
														...
														<option <?php if (isset($result[0]['gender'])) { if($result[0]['gender'] == 'male'){echo 'selected'; } } ?> value="male">Male</option>
														<option <?php if (isset($result[0]['gender'])) { if($result[0]['gender'] == 'female'){echo 'selected'; } } ?> value="female">Female</option>
													 </select>
													 <i class="bar"></i>
												</div>
												<div class="form-group custom-mt-form-group">
										...
										<div class="col-lg-6 col-md-6 col-sm-6 col-12">
												...
												<div class="form-group custom-mt-form-group">
													<input type="text"  name="admission_fee" placeholder="Admission Fee" value="<?php
                                        		if (isset($result[0]['admission_fee']))
                                            	echo htmlspecialchars($result[0]['admission_fee']);
                                        		?>"/>
													<i class="bar"></i>
												</div>
										</div>
